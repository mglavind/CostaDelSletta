...
class HTMXGodkendelseListView(generic.ListView):
...
class HTMXGodkendelseCreateView(generic.CreateView):
    model = models.Godkendelse
    form_class = forms.GodkendelseForm
...
class HTMXGodkendelseDeleteView(generic.DeleteView):
    model = models.Godkendelse
    success_url = reverse_lazy("Poster_Godkendelse_htmx_list")
...
class HTMXOpgaveListView(generic.ListView):
    model = models.Opgave
...
class HTMXOpgaveCreateView(generic.CreateView):
    model = models.Opgave
    form_class = forms.OpgaveForm
...
class HTMXOpgaveDeleteView(generic.DeleteView):
    model = models.Opgave
    success_url = reverse_lazy("Poster_Opgave_htmx_list")
